...
public class FragmentStudyDateBindingImpl extends FragmentStudyDateBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.studydate, 1);
    ...
    public FragmentStudyDateBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 32, sIncludes, sViewsWithIds));
    }
    private FragmentStudyDateBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.example.wordbook.study.StudyDateViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.example.wordbook.study.StudyDateViewModel ViewModel) {
